...
import { Search, CheckSquare, BookOpen, Wallet, CalendarDays, ArrowRight } from "lucide-react"
...
export function CommandPalette({ isOpen, onClose }: { isOpen: boolean, onClose: () => void }) {
  ...
  return (
    <Modal isOpen={isOpen} onClose={onClose} size="lg">
      <div className="flex flex-col h-[420px] -m-6">
        <div className="flex items-center px-4 py-3 border-b border-surface-700 bg-surface-900/50">
          ...
          <input 
            ...
            placeholder="Buscar tarefas, gastos, matérias ou comandos..."
            value={query}
        ...
        <div className="flex-1 overflow-y-auto p-3">
          {isLoading ? (
            ...
            <div className="space-y-1">
              ...
              {[
                { title: "Ir para Tarefas", page: "tasks" as const, icon: CheckSquare },
                { title: "Ir para Finanças", page: "finances" as const, icon: Wallet },
                { title: "Ir para Estudos", page: "studies" as const, icon: BookOpen },
                { title: "Abrir Resolva AI", page: "ai" as const, icon: Search },
              ].map((act, i) => (
                <button
                  key={i}
